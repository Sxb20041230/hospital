...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/buttoms.css">
        ...
        <table class="table table-hover text-center">
            ...
            <c:forEach items="${departmentList}" varStatus="v" var="b">
                ...
                <tr>
                    ...
                    <td>${b.department_description}</td>


                   <td>${ b.department_pid==null?'是':'否'}</td>
                </tr>
            </c:forEach>
                <tr>

                    <td colspan="8"> <div class="fixed-buttons"><div class="pagelist">
